...
class Main(Mian_Widget):
    def __init__(self):
        ...
        try:
            self.add_info(dezerlin_welcome.dezerlin_show, False)
        except:
            pass
    ...
    def start_unpack(self):
        ...
        if drives_map_status:
            pack_dir = self.unpack_widget.pack_dir_edit.text()
            new_files = fp.unpack(pack_dir, root_map=drives_map)
            for f in new_files:
    ...
    def start_pack(self):
        ...
        if project_file and export_dir:
            ...
            pack_info = fp.pack(project_file, export_dir, ignore_paths=ignore_paths)
            if pack_info:
...
if __name__ == "__main__":
    # pk_folder = "D:/temp/c10490.cmp.v002"
    # root_map = {'E': 'D:/projects', 'D': 'E:/projects'}
    # fp.unpack(pk_folder, root_map=root_map)

    # file = "E:/bproject/wts/work/shot/c10/c10490/cmp/c10490.comp.composite.v001/nuke/script/c10490.cmp.v002.nk"
    # pk_folder = "D:/temp"
    # fp.pack(file, pk_folder)
